...
import { RequestPaymentProps, useRequestPayment } from '../_hooks/use-request-payment';
...
export function PaymentSuccess({ data, virtualAccount, orderNumber, orderName }: Props) {
        ...
        <>
            ...
            <div className="w-full space-y-4">
                ...
                {virtualAccount && (
                    <>
                        <div className="bg-foreground/5 space-y-3 rounded-lg p-4">
                            <h3 className="text-foreground text-sm font-semibold">입금 정보</h3>
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    <span className="text-muted-foreground text-sm text-nowrap">
                                        은행
...
function PaymentProcessingContent() {
    return (
        <div className="flex flex-col items-center gap-y-6">
            ...
            <div className="text-center">
                <h2 className="text-foreground mb-2 text-2xl font-bold">결제 승인 요청중</h2>
